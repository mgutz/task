...
export declare const addSeriesRef: (
  tasks: Tasks,
  task: Task,
  deps: any[]
) => string
export declare const makeParallelRef: (
  tasks: Tasks,
  task: Task,
  dep: any
) => string
export declare const depToRef: (
  tasks: Tasks,
  task: Task,
  dep: any
) => string | null
 ...
 */
export declare const configureBabel: (
  argv: Options,
  taskfilePath: string
) => void
/**
 ...
 * }
 */
export declare const loadTasks: (
  argv: Options,
  taskfilePath: string
) => Promise<Tasks | null>
export declare const standardizeFile: (v: any) => Tasks
